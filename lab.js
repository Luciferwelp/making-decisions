...
if (temperature >= 80 & rain) {
  console.log("one should wear a t-shirt and take an ummbrella.");
...
if (temperature >= 60 & temperature <= 80 & rain) {
  ...
  console.log("one should wear jeans and a light jacket.");
}
...
// !changeMyMind
console.log("Should be False", changeMyMind)
